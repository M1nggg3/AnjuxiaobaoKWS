...
$expDir = Join-Path $projectRoot "experiments\rkreal_realvoice_tts_20260508_001"
$testData = Join-Path $projectRoot "data\prepared_tts_rkreal_realvoice_tts_20260508\test\data.list"
$dictDir = Join-Path $projectRoot "dict\tts_rkreal_realvoice_tts_20260508"
